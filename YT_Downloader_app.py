        ...
        if not url:
            ...
            if info:
                ...
                if format_choice == "MP4 (Video)":
                    ...
                    ydl_opts = {
                        **common_opts,
                        # FIX: Use a more flexible format string. 
                        # This looks for best MP4, but falls back to any best video+audio if MP4 isn't found, 
                        # then converts the final result to mp4.
                        'format': 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best',
                        'postprocessors': [{
                            'key': 'FFmpegVideoConvertor',
                            'preferedformat': 'mp4',
